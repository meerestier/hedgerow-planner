...
from qgis.core import (QgsProject, QgsVectorLayer, QgsFeature, QgsGeometry, 
                       QgsPointXY, QgsFields, QgsField, QgsLineString, QgsWkbTypes)
...
class HedgerowPlanner:
    ...
    def run(self):
        ...
        # Show a dialog to get user inputs
    ...
    def generate_points(self, rows, row_spacing, plant_spacing):
        ...
        point_layer = QgsVectorLayer('Point?crs=EPSG:4326', 'Hedgerow Points', 'memory')
        ...
        for feature in line_layer.getFeatures():
            ...
            for line in lines:
                line_string = QgsLineString(line)
                ...
                for row in range(rows):
                    ...
                    while distance < line_length:
                        point = line_string.interpolate(distance).asPoint()
                        offset_angle = line_string.interpolate(distance).angle() + 90
